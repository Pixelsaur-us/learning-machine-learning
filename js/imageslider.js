(function ($) {
	...
	var init = function () {
		...
		$this.find('.right.image').css('left' , Math.floor(width * settings.initialPosition));
		$this.find('.right.image img').css('left' , -Math.floor(width * settings.initialPosition));
	...
	var slideResize = function (e) {
		...
		if (width<=$(this).width()){
			...
			$(this).find('.right.image').css('left', width + 'px');
			$(this).find('.right.image img').css('left', -width + 'px');
		}
	};
